                                      ...
                                      child: ListTile(
                                        ...
                                        trailing: Row(
                                          ...
                                          children: [
                                            ...
                                            RawMaterialButton(
                                                onPressed: () {
//TODO: Delete the show dialog and delete the tenant
                                                },
                                                child: const Icon(
                                          ...
                                          child: RawMaterialButton(
                                            ...
                                            onPressed: () async {
                                              ...
                                              if (newInfo != null && mounted) {
                                                newInfo.buildingID =
                                                    TempValues.curBuildingID;
                                                newInfo.unitID =
                                                    TempValues.curUnitID;
                    ...
                    MaterialButton(
                      ...
                      onPressed: () async {
                        ...
                        if (newInfo != null && mounted) {
                          newInfo.buildingID = TempValues.curBuildingID;
                          newInfo.unitID = TempValues.curUnitID;
              ...
              Padding(
                ...
                child: Container(
                  ...
                  width: SizeHelper.displayWidth! * 0.40,
                  // height: SizeHelper.displayHeight,
                  child: Column(
