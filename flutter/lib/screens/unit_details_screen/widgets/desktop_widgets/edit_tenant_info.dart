...
class EditTenantInfo extends StatefulWidget {
  final TenantInfo? tenantInfo;

  const EditTenantInfo({super.key, required this.tenantInfo});

  @override
  State<EditTenantInfo> createState() => _EditTenantInfoState();
}

class _EditTenantInfoState extends State<EditTenantInfo> {
